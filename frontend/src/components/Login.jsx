...
function Login() {
  return (
    <div class="flex h-screen bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
      <div class="flex w-full flex-col items-center justify-center">
        <h1 class="text-4xl	text-white"> Amigo Animal </h1>
        <div class="w-full bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-5">
          <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Faça login na sua conta</p>
          <div class="mt-6">
          ...
          <div class="mt-8">
            <Link to="/">
                <button role="button" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full"> ENTRAR </button>
            </Link>
          </div>
        </div>
      </div>
