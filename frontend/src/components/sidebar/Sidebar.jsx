...
function Sidebar(props) {
    return (
        <div id="menu" class="bg-my-black col-span-3 rounded-lg p-4 shadow-[10px_10px_5px_-3px_rgba(0,0,0,0.36)]">
            ...
            <div href="#" class="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-my-black group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                <div>
